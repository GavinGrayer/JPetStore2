...
<div id="Header">
  ...
  <div id="Menu">
    <div id="MenuContent">
          <a href="<%=basePath%>/cart"><img align="middle" name="img_cart" src="<%=basePath%>/images/cart.gif" /></a>
      
         <img align="middle" src="<%=basePath%>/images/separator.gif"/>
      
       <a href="<%=basePath%>/toSignonForm">登录</a>
       <img align="middle" src="<%=basePath%>/images/separator.gif"/>
       <a href="<%=basePath%>/EditAccountForm">我的账户</a>
    </div>
  </div>
